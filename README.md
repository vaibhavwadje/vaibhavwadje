...
<a href="mailto:vaibhavwadje309@gmail.com">
...
A face detection and recognition based attendance system built with Python.

**Tech:** Python, OpenCV, Pandas, NumPy

**Key Features:**
- Face detection and recognition for automated attendance
- Image processing pipeline using OpenCV

---

### 📈 Trading Bot with MT4 & MT5 Integration

A Python-based trading bot that fetches historical and live trading data and performs basic analysis.

**Tech:** Python, MT4, MT5

**Key Features:**
- Order placement, status tracking, and buy/sell operations
